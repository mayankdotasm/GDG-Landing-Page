...
const TeamCard: React.FC<TeamCardProps> = ({ name, role, instagram, twitter, github, linkedin, profileLink }) => {
  // Default fallback image
  const fallbackImage = "https://res.cloudinary.com/drnjjbg2a/image/upload/t_Profile/v1731150003/fallbackimage_pehasf.jpg";
